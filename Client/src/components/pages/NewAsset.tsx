...
import {
  ...
  isBulkImportAllowedCategorySlug,
...
export default function NewAsset() {
  ...
  const bulkImportEnabled =
    effectiveSlug !== 'other' && effectiveSlug != null && isBulkImportAllowedCategorySlug(effectiveSlug)
      ...
      <div className="max-w-6xl mx-auto space-y-5">
            ...
            <div className="flex flex-wrap items-center gap-2 shrink-0 sm:pt-0.5">
              ...
              >
                ...
                <p>
                  ...
                  <code className="text-[0.8rem] text-primary">ram_gb</code>). Do not include{' '}
                  <code className="text-[0.8rem] text-primary">category_slug</code> — rows use the category selected
                  on this page. Asset tags are generated by the system. Assignment columns are not allowed.
                </p>
                <p>
                  If the same <span className="text-primary font-medium">category + serial</span> appears twice in the
                  file, the entire import is cancelled before anything is saved.
                </p>
              ...
              <button
                ...
                title={
                  bulkImportEnabled
                    ? undefined
                    : 'Choose a standard category (not Other) to bulk import.'
                }
        ...
        {bulkImportEnabled ? (
          <AssetBulkImportModal
            ...
            fixedCategorySlug={effectiveSlug as string}
          />
        ) : null}
