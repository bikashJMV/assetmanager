-- 15_fn_assign_assigned_at_coalesce.sql
-- PostgREST/Supabase callers often pass p_assigned_at := null explicitly; that overrides
-- the SQL parameter DEFAULT now() and caused NOT NULL violations on asset_assignments.assigned_at.
